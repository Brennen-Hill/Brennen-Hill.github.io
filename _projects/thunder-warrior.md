...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="assets/video/gameVideo.mp4" class="video-universal img-fluid rounded z-depth-1 embed-responsive-16by9 embed-responsive" controls=true autoplay=true %}
    </div>
</div>
<div class="caption">
    Launch trailer.
