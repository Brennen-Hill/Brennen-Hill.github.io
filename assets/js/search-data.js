...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "My peer-reviewed publications, which represent large-scale research projects, are detailed on the publications page. This page is dedicated to my other projects.",
          section: "Navigation",
          handler: () => {
