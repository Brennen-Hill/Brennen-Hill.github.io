...
2.  **Boracite Plasmablade (Cyan)**
    ...
    _ **Precision**: 2.75 \* **Init Time**: 0.35s
3.  **Alabaster Plasmablade (White)**
    ...
    _ **Precision**: 1.9 \* **Init Time**: 1.5s
...
18. **Heal (`Heal`)**
    ...
    _ **Cost**: 1000 Stamina, 50 Thaumaturgy \* **Prerequisites**: None
19. **Oneness (`Oneness`)**
...
23. **Shield (`Shield`)**
    ...
    _ **Cost**: 560 Stamina \* **Prerequisites**: Defensive
24. **Fast Fire (`FastFire`)**
    ...
    _ **Cost**: 520 Stamina, 15 Thaumaturgy \* **Prerequisites**: Heal
...
9.  **HealAura (`HealAura`)**
    ...
    _ **Cost**: 105 Thaumaturgy \* **Prerequisites**: Group Preparation
10. **Push (`Push`)**
...
13. **Repulse (`Repulse`)**
    ...
    _ **Cost**: 240 Stamina, 130 Thaumaturgy \* **Prerequisites**: Life Drain
14. **Weaken (`Weaken`)**
...
20. **Choke (`Choke`)**
    note: _this response is an exact copy of the provided text_
    ...
    _ **Cost**: 130 Thaumaturgy \* **Prerequisites**: Hold
21. **Reversal (`Reversal`)**
    ...
    _ **Cost**: 70 Thaumaturgy \* **Prerequisites**: Tether
...
25. **Overheat (`Overheat`)**
    ...
    _ **Cost**: 100 Thaumaturgy \* **Prerequisites**: Tether
26. **Freeze (`Freeze`)**
    - **Class/Subclass**: Control / Immobalize
